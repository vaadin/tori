...
(function() {
	...
	var bbcodeMap = { b: 'strong', u: 'u', s: 's',i: 'em', color: 'span', size: 'span', font: 'span', quote: 'blockquote', code: 'code', url: 'a', email: 'span', img: 'span', '*': 'li', list: 'ol' },
		convertMap = { strong: 'b', b: 'b', u: 'u', em: 'i', i: 'i', code: 'code', li: '*' },
		tagnameMap = { strong: 'b', em: 'i', u: 'u', li: '*', ul: 'list', ol: 'list', code: 'code', a: 'link', img: 'img', blockquote: 'quote', s: 's' },
					...
					if ( optionPart ) {
						...
						if ( stylesMap[ part ] ) {
							...
							if ( part == 'size' ){
                                ...
                                optionPart = sizeMap[optionPart] || "medium";
							} 
